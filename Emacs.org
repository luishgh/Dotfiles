...
- [[#about-this-config][About This Config]]
  - [[#list-of-todos][List of TODOS]]
    ...
    - [[#remove-exwm-related-stuff-i-wont-be-using-it-again-anytime-soon-][Remove EXWM related stuff, I won't be using it again anytime soon :/]]
...
*** TODO Remove EXWM related stuff, I won't be using it again anytime soon :/
...
#+begin_src emacs-lisp :tangle no
  (require 'use-package)
  (setq use-package-always-ensure (not (executable-find "guix"))) ;; Install a package if it isn't installed already on systems without Guix
...
#+begin_src scheme
  ...
  ;; "emacs-pinentry"
  ;; "pinentry-emacs" this is installed via guix home
